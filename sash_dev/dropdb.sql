...
prompt 
accept DBID prompt "Enter SASH_DBID of target database to drop "
...
begin
 select db_link into :dblink from sash_targets where sash_dbid = '&DBID' and inst_num = &INST_NUM;
 delete from sash_targets where sash_dbid = '&DBID' and inst_num = &INST_NUM;
